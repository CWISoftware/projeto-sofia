...
var UsuarioLogadoComponent = (function () {
    function UsuarioLogadoComponent() {
        this.data = {
            colaborador: {
                id: 1,
    ...
    UsuarioLogadoComponent = __decorate([
        core_1.Component({
    ...
    return UsuarioLogadoComponent;
}());
exports.UsuarioLogadoComponent = UsuarioLogadoComponent;
//# sourceMappingURL=usuario-logado.component.js.map